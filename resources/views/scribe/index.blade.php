                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-products--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-carts">
                                <a href="#endpoints-GETapi-carts">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-carts">
                                <a href="#endpoints-POSTapi-carts">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-carts--id-">
                                <a href="#endpoints-GETapi-carts--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-carts--id-">
                                <a href="#endpoints-PUTapi-carts--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-carts--id-">
                                <a href="#endpoints-DELETEapi-carts--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;slug&quot;: &quot;tech&quot;,
            &quot;parent_id&quot;: null,
            &quot;created_at&quot;: &quot;2025-07-10T13:28:16.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2025-07-10T13:28:16.000000Z&quot;,
            &quot;children&quot;: [
                {
                    &quot;id&quot;: 3,
                    &quot;name&quot;: &quot;Laptops&quot;,
                    &quot;slug&quot;: &quot;laptops&quot;,
                    &quot;parent_id&quot;: 1,
                    &quot;created_at&quot;: &quot;2025-07-11T14:12:12.000000Z&quot;,
                    &quot;updated_at&quot;: &quot;2025-07-11T14:12:12.000000Z&quot;
                },
                {
                    &quot;id&quot;: 4,
                    &quot;name&quot;: &quot;Phones&quot;,
                    &quot;slug&quot;: &quot;phones&quot;,
                    &quot;parent_id&quot;: 1,
                    &quot;created_at&quot;: &quot;2025-07-11T14:12:21.000000Z&quot;,
                    &quot;updated_at&quot;: &quot;2025-07-11T14:12:21.000000Z&quot;
                }
            ]
        }
    ]
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    ...
    --form "stock=17"\
    --form "images[]=@C:\Users\hmusa\AppData\Local\Temp\php5133.tmp" </code></pre></div>
...
<p>The ID of the product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-carts">Display a listing of the resource.</h2>
...
<span id="example-requests-GETapi-carts">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-carts">
            <blockquote>
...
<span id="execution-results-GETapi-carts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-carts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-carts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-carts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-carts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-carts" data-method="GET"
      data-path="api/carts"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-carts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-carts"
                    onclick="tryItOut('GETapi-carts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-carts"
                    onclick="cancelTryOut('GETapi-carts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-carts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-carts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-carts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-carts">Store a newly created resource in storage.</h2>
...
<span id="example-requests-POSTapi-carts">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-carts">
</span>
<span id="execution-results-POSTapi-carts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-carts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-carts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-carts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-carts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-carts" data-method="POST"
      data-path="api/carts"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-carts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-carts"
                    onclick="tryItOut('POSTapi-carts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-carts"
                    onclick="cancelTryOut('POSTapi-carts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-carts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-carts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-carts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="product_id"                data-endpoint="POSTapi-carts"
               value="consequatur"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="POSTapi-carts"
               value="45"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-GETapi-carts--id-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-carts--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/carts/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/carts/consequatur"
);
...
<span id="example-responses-GETapi-carts--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-carts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-carts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-carts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-carts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-carts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-carts--id-" data-method="GET"
      data-path="api/carts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-carts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-carts--id-"
                    onclick="tryItOut('GETapi-carts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-carts--id-"
                    onclick="cancelTryOut('GETapi-carts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-carts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-carts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the cart. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-carts--id-">Update the specified resource in storage.</h2>
...
<span id="example-requests-PUTapi-carts--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-carts--id-">
</span>
<span id="execution-results-PUTapi-carts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-carts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-carts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-carts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-carts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-carts--id-" data-method="PUT"
      data-path="api/carts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-carts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-carts--id-"
                    onclick="tryItOut('PUTapi-carts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-carts--id-"
                    onclick="cancelTryOut('PUTapi-carts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-carts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-carts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the cart. Example: <code>consequatur</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="PUTapi-carts--id-"
               value="73"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>73</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-carts--id-">Remove the specified resource from storage.</h2>
...
<span id="example-requests-DELETEapi-carts--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-carts--id-">
</span>
<span id="execution-results-DELETEapi-carts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-carts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-carts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-carts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-carts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-carts--id-" data-method="DELETE"
      data-path="api/carts/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-carts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-carts--id-"
                    onclick="tryItOut('DELETEapi-carts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-carts--id-"
                    onclick="cancelTryOut('DELETEapi-carts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-carts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-carts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-carts--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the cart. Example: <code>consequatur</code></p>
...
<p>Returns a list of all products with their associated images.</p>
<p>This endpoint retrieves all available products in the database, along with any images attached to them.
It requires authentication.</p>
...
<p>Creates a new product with a name, price, stock quantity, description, category, and one or more images.</p>
...
<div class="bash-example">
    ...
    --form "price=999.99"\
    --form "stock=50"\
    --form "description=Latest iPhone with improved camera"\
    --form "category_id=3"\
    --form "images[]=@C:\Users\hmusa\AppData\Local\Temp\php5132.tmp" </code></pre></div>
...
const body = new FormData();
body.append('name', 'iPhone 15');
body.append('price', '999.99');
body.append('stock', '50');
body.append('description', 'Latest iPhone with improved camera');
...
&nbsp;
 &nbsp;
               ...
               data-component="header">
    <br>
<p>Example: <code>Bearer your-api-token-here</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the product. Example: <code>iPhone 15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>price</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>How many items in stock. Example: <code>50</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value="Latest iPhone with improved camera"
               data-component="body">
    <br>
<p>The product description (optional). Example: <code>Latest iPhone with improved camera</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The ID of the category this product belongs to. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>images</code></b>&nbsp;&nbsp;
<small>file[]</small>&nbsp;
 &nbsp;
        ...
        <input type="file" style="display: none"
               ...
               data-component="body">
    <br>
<p>Array of image files (JPEG, PNG, etc.). Each must be under 2MB.</p>
        </div>
        </form>
